...
![Space confirmation or Space sidebar showing the Space name and key](screenshots/spacejira.png)
...
![Backlog showing the Epic panel enabled and the Epic visible](screenshots/epicpanel.png)
...
![Backlog showing the Epic and all six Stories under it](screenshots/sixseededstories.png)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![One opened Story showing its Story point estimate, acceptance criteria, and label](screenshots/storypointetc.png)
...
![S2 showing all four Sub-tasks](screenshots/S2subtasks.png)
...
![S4 showing all four Sub-tasks](screenshots/S4subtasks.png)
...
![Epic showing Child Stories with their Labels](screenshots/labelsforStories.png)
...
![Sprint 1 before starting, showing the selected Stories and Story Points](screenshots/sprint1beforestart.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Active Sprint board showing the started Sprint and Sprint Goal](screenshots/sprintstartedandgoal.png)
...
![Filter for label = frontend showing the filtered results](screenshots/forntendsprint.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![ Filter for label = devops showing the filtered results](screenshots/devopsfilter.png)
...
![Burndown Chart page opened for Sprint 1](screenshots/burndown.png)
