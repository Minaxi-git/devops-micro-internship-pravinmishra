...
![git status` and `git branch` showing a clean status and the default branch checked out](screenshots/Branchmasterstatus.png)
...
![`git checkout -b feature/contact-page` and `git branch` showing `* feature/contact-page`](screenshots/switchfeaturecontactpagebranch.png)
...
![`ls` showing `contact.html`](screenshots/createcontactdothtml.png)

---

#### Screenshot 4 — Output of `git commit`

![Output of `git commit`](screenshots/contactcommitafterpastingcontent.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Output of `git log --oneline -3`](screenshots/gitLog-3.png)
...
![`git status` showing `index.html` as modified before staging](screenshots/gitstatusforIndexupdate.png)

---

#### Screenshot 7 — Output of `git commit`

![Output of `git commit](screenshots/gitcommitindex.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Browser showing the Contact Page link on the homepage while on `feature/contact-page`](screenshots/withand%20withoutcontact.png)
...
![Terminal showing the checkout and `ls` output, proving `contact.html` is absent](screenshots/isolationOfContact.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![](screenshots/withand%20withoutcontact.png)
...
![`git merge feature/contact-page` Output](screenshots/gitmergecontctpage.png)
---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![`ls` showing `contact.html` after the merge](screenshots/lsShowContact.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Browser showing the Contact page opened from the homepage link on the default branch](screenshots/contactpagefromdefault.png)
![showing Index.html from default](screenshots/defaultshowingcontactaftermerge.png)
...
![output of `git log --oneline --graph --decorate --all`](screenshots/gitlogGraph.png)
...
![`feature/contact-page` deleted and no longer listed](screenshots/cleanedfeaturebranch.png)
