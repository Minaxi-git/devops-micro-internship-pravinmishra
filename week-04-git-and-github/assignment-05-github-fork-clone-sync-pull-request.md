...
![Fork `pravinmishraaws/devops-micro-internship-interviews`](screenshots/forkinterviews.png)
...
![`ssh -T git@github.com` (SSH) showing successful authentication](screenshots/ssh-T-gitkeyautenticated.png)
...
![Output of `git remote -v` showing `origin` pointing to your fork and `upstream` pointing to `pravinmishraaws/devops-micro-internship-interviews`](screenshots/upstreamremoteintterviews.png)
...
![Output of `git status` showing `pull_request.md` modified before staging](screenshots/changesnotcomittedforpullrequestdotmd.png)

---

#### Screenshot 5 — Output of `git commit`

![git commit -m "docs: add my name to student list"](screenshots/commitadddmyname.png)
...
![`git push -u origin feature-readme-update` showing a successful push](screenshots/pushorigin-feature-readme-update.png)

---

#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner

!["Compare & pull request" banner](screenshots/compareoullchangesgit.png)
...
![Pull Request creation page showing the correct base repository, base branch, head repository, compare branch, and title](screenshots/pullrequestcreation.png)

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![Successfully created Pull Request page with the PR number visible](screenshots/pullrequestnumber454.png)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/454`
...
`https://lnkd.in/p/eqgcs2JG`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![LinkedIn post showing your successfully created Pull Request](screenshots/linkedinforpullfeatre.png)
