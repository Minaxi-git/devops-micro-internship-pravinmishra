...
![Folders for hooks](..\screenshots\Foldersforhooks.png)
...
![user-prompt-guard.sh](..\screenshots\UserPromptHook.png)
...
![pre-tool-guard.sh](..\screenshots\PretoolHook.png)
...
![post-tool-logger.sh](..\screenshots\PostToolLogHook.png)
...
![settings.json](..\screenshots\settingsdotjsonfor hooks.png")
...
![UserPromptSubmit hook blocking the destructive prompt](..\screenshots\userpromptblocked.png)
---
...
![PreToolUse hook blocking terraform destroy](..\screenshots\PreToolDestructionBlocked.png)
---
...
![Claude running terraform validate successfully](..\screenshots\TerraformValid.png)

#### Screenshot 9 — `.claude/deploy.log` showing the logged command
![PreToolUse hook blocking terraform destroy](..\screenshots\PreToolDestructionBlocked.png)
![.claude/deploy.log](..\screenshots\DotClaudeDeployLogproof.png)
---
