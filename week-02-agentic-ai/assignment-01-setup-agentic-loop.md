...
![Screenshot 1 Claude Code Version](screenshots/ClaudeCodeVersion.png)

---

#### Screenshot 2 — Claude Code authenticated and showing the terminal prompt (your name visible)

 ![Screenshot 2 Claude Prompt Appears](..\screenshots\claudePromptAppears.png)
---
...
#### Screenshot 3 — VS Code with the project open, file tree visible showing `index.html`, `style.css`, `images/`
 ...
 ![Screenshot 3 File Tree](..\screenshots\filetree.png)
...
![Screenshot 4 Files In this Project](..screenshots\FilesInthisProject.png)

---

#### Screenshot 5 — Claude's response to the second question, showing it ran a command and reported the line count

 ![Screenshot 4 How Many Lines of CSS](..\screenshots\HowManyLinesofCSS.png)
